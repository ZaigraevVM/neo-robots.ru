...
namespace SMI.Areas.Admin.Controllers
{
    ...
    public class AggregatorListsController : Controller
    {
        private readonly IAggregatorListsManager _mgr;
        private readonly IViewRender _view;
        public AggregatorListsController(IAggregatorListsManager mgr, IViewRender view)
        {
            _mgr = mgr;
            _view = view;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> SaveAsync(AggregatorListEdit m)
        {
